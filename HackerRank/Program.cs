...
namespace HackerRank
{
   ...
   class Solution
   {
      ...
      {
         SherlockAndTheGcd(Convert.ToInt32(Console.ReadLine().ToString()));
      }

      public class gcdDigit
      {
         public long Digit { get; set; }
         private List<long> _factors = null;
      ...
      private static IEnumerable<gcdSubSet> GetSubsets(gcdDigit[] arrayOfDigits)
      {
      ...
      private static void SherlockAndTheGcd(int numOfTestCases)
      {
     ...
     //    Console.ReadLine();
      ...
      private static bool SubSetExists(int digitCount, int[] arrayOfNums)
      {
      ...
      private static void TaumAndBday(int numOfTestCases)
      {
         for (int i = 0; i < numOfTestCases; i++)
         {
      ...
      private static void AcmIcpcTeam()
      {
      ...
      private static void manasaAndStones(int numOfTestCases)
      {
         for (int i = 0; i < numOfTestCases; i++)
         {
      ...
      private static void halloweenParty(int numberOfTestCases)
      {
      ...
      private static void theAngryProfessor(int numberOfTestCases)
      {
         for (int i = 0; i < numberOfTestCases; i++)
         {
            var inputLine1 = Console.ReadLine().Split(' ').Select(s => Convert.ToInt32(s)).ToArray();
      ...
      private static void cutTheSticks(int numberOfSticks)
      {
      ...
      private static void lonelyInteger(int numberOfIntegers)
      {
      ...
      private static void loveLetterMystery(int testCaseNumber)
      {
      ...
      private static void serviceLanes(string[] inputLine1, string[] inputLine2)
      {
      ...
      private static int maximisingXor(int leftVal, int rightVal)
      {
         int retVal = 0;
      ...
      private static void utopianTree(int noOfTests, int initialHeight = 1)
      {
      ...
      private static void solveMeSecond(int linesToRead)
      {
